...
import com.android.volleyplus.cache.DiskLruBasedCache.ImageCacheParams;
import com.android.volley.VolleyError;
import com.android.volleyplus.misc.NetUtils;
import com.android.volleyplus.misc.Utils;
import com.android.volley.toolbox.BasicNetwork;
import com.android.volley.toolbox.HttpClientStack;
import com.android.volley.toolbox.HurlStack;
import com.android.volleyplus.toolbox.ImageLoader.ImageCache;
import com.android.volleyplus.toolbox.ImageLoader;
import com.android.volleyplus.ui.PhotoView;
...
public class SimpleImageLoader extends ImageLoader {
    ...
    /**
     * Flushed {@link Cache} and clears {@link com.android.volleyplus.toolbox.ImageCache}.
     */
    public void flushCache() {
        if (getImageCache() instanceof IExtendedCache) {
            ((IExtendedCache)getImageCache()).clear();
        }
        if (getCache() instanceof IExtendedCache) {
            ((IExtendedCache)getCache()).flush();
        }
	}
